...
class NewEnvironmentUR(URBaseEnv):
    ...
    # We have changed c_w to -10, reward = g_w * 4 instead of * 2,
    ...
    def reward(self, rs_state, action) -> Tuple[float, bool, dict]:
        ...
        if last_distance < euclidean_dist_3d:
            reward -= b_w * euclidean_dist_3d
        else:
...
class NewEnvironmentURSim(NewEnvironmentUR, Simulation):
    ...
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, ur_model='ur5', **kwargs):
        ...
        NewEnvironmentUR.__init__(self, rs_address=self.robot_server_ip, ur_model=ur_model, **kwargs)

class NewEnvironmentURRob(NewEnvironmentUR):
    real_robot = True
