...
class NewMazeMir100Sim(NewMazeMir100, Simulation):
    cmd = "roslaunch mir100_robot_server sim_robot_server.launch world_name:=testmaze.world"
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, **kwargs):
        Simulation.__init__(self, self.cmd, ip, lower_bound_port, upper_bound_port, gui, **kwargs)
        NewMazeMir100.__init__(self, rs_address=self.robot_server_ip, **kwargs)

class NewMazeMir100Rob(NewMazeMir100Sim):
    real_robot = True
