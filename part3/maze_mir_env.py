...
class MazeMir100Sim(MazeMir100, Simulation):
    cmd = "roslaunch mir100_robot_server sim_robot_server.launch world_name:=testmaze.world gazebo_gui:=true rviz_gui:=true"
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=True, **kwargs):
        Simulation.__init__(self, self.cmd, ip, lower_bound_port, upper_bound_port, gui, **kwargs)
        MazeMir100.__init__(self, rs_address=self.robot_server_ip, **kwargs)

class MazeMir100Rob(MazeMir100):
    real_robot = True
