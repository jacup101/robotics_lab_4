...
register(
    id='MazeMir100Sim-v0',
    entry_point='robo_gym.envs:MazeMir100Sim',
)

register(
    id='MazeMir100Rob-v0',
    entry_point='robo_gym.envs:MazeMir100Rob',
)

register(
    id='NewMazeMir100Sim-v0',
    entry_point='robo_gym.envs:NewMazeMir100Sim',
)

register(
    id='NewMazeMir100Rob-v0',
    entry_point='robo_gym.envs:NewMazeMir100Rob',
)
...
register(
    id='NewEnvironmentURSim-v0',
    entry_point='robo_gym.envs:NewEnvironmentURSim',
)

register(
    id='NewEnvironmentURRob-v0',
    entry_point='robo_gym.envs:NewEnvironmentURRob',
)
